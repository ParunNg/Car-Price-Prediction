...
app.layout = dbc.Container([
    dbc.Row([
        html.Div([
            ...
            dbc.Input(id="max_power", type="number", min=0, placeholder="Put a value for max power" style={"margin":'30px', "padding": '20px'}),

            dbc.Label("Year"),
            dbc.Input(id="year", type="number", min=0, placeholder="Put a value for year" ),

            dbc.Label("Fuel"),
            dcc.Dropdown(id='fuel', options=list(fuel_le.classes_), value='Diesel'),
            ...
            html.Output(id="selling_price", children="", style={"margin-left": "10px"})
            ],
            style={"margin-top": "15px"})
        ],
        className="mb-3", style={"margin":'30px', "padding": '20px'})
    ])
