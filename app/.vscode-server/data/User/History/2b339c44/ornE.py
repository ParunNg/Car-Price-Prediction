...
app.layout = dbc.Container([
    dbc.Row([
        html.Div([
            ...
            dbc.Button(id="submit", children="calculate selling price", color="primary", style={"margin-top": "15px"}),

            dbc.Label("Selling price is: ", style={"margin-left": "5px", "margin-right": "5px"}),
...
def calculate_selling_price(max_power, year, engine, fuel, brand, submit):
    ...
    return np.round(np.exp(model.predict(X)), 2)
