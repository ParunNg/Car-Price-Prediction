...
default_vals = {'max_power': 82.4, 'year': 2015, 'engine': 1248}
...
app.layout = dbc.Container([
    dbc.Row([
        html.Div([
            ...
            dbc.Label("Year"),
            dbc.Input(id="year", type="number", min=0, max=datetime.now().year, placeholder="Put a value for year"),
